...
SECRET_KEY = 'django-insecure-xn&^2s9*6%-6ffrx7g0(w+c=vr1w#1j5nrkw&5fdx#eezdmh)-'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Madhu@123',       # Replace with your MySQL password
...
# Ensure you specify the directory for static files
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "static"),
]

# If you're using images for background, make sure you add this as well
MEDIA_URL = '/media/'
...
# Other settings (database, templates, middleware, etc.)
